...
template enum compress_status_type compress<CUDA>(DIM D, data_type dtype,
...
template enum compress_status_type compress<CUDA>(
...
template void pin_memory<CUDA>(void * ptr, SIZE num_bytes);
template bool check_memory_pinned<CUDA>(void * ptr);
template void unpin_memory<CUDA>(void * ptr);
